    ...
    <html>
      ...
      <body>
        <form {{url_for('chatbotsystem')}} method="POST">
          ...
          <div class="icon">
    	<img src="/static/chat.jpg"></img>
          </div>
          <div class="formcontainer">
          <div class="container">
           <label for="ufname"><strong>WELCOME</strong></label></br></br>
    	  <label for="ufname"><strong>Copy and paste your questions from below list</strong></label></br>
    	  <label for="ufname"><strong>1.Does the college have a football team?</strong></label></br>
    	  <label for="ufname"><strong>2.Does the college have a Computer Science Major?</strong></label></br>
    	  <label for="ufname"><strong>3.What is the in-state tuition?</strong></label></br>
    	  <label for="ufname"><strong>4.Does the college have on-campus housing?</strong></label></br>
    """

ChatWindowHTMLLast = """
    </div>
    	<div class="text-box">
            <input type="text" name="question" id="message" autocomplete="off" placeholder="Copy and paste your questions here">
...
def chatbotsystem():
    ...
    if request.method == 'POST' and str(request.form['question']) !="":
        ...
        if(questionasked in "Does the college have a football team?"):
            ...
            <label for ="ufname"><strong> Yes, the college has a football team name </strong></label></br>
            """
            # answergiven="Yes! Bearcats is the football team name"
        elif(questionasked in "Does the college have a Computer Science Major?"):
            ChatWindowHTMLMiddle = """
            </br><label for="ufname" style="color:blue;"><strong>""" + questionasked + """</strong></label></br>
            ...
            <label for ="ufname"><strong>For in-state students its $7500/semester ans for international students it is $15000 /semester</strong></label></br>
            """
            # answergiven = "For in-state students its $7500/semester ans for international students it is $15000 /semester"
        elif (questionasked in "Does the college have on-campus housing?"):
            ChatWindowHTMLMiddle = """
            </br><label for="ufname" style="color:blue;"><strong>""" + questionasked + """</strong></label></br>
            <label for ="ufname"><strong>Yes, The college has campus hosuing facility</strong></label></br>
            """
            # answergiven = "Yes, The college has campus hosuing facility"
        else:
            ChatWindowHTMLMiddle = """
            </br><label for="ufname" style="color:blue;"><strong>""" + questionasked + """</strong></label></br>
            <label for ="ufname"><strong>Please enter correct question</strong></label></br>
            """
            # answergiven = "Please enter correct question"
  ...
  <body>
    <form>
	 ...
	 <img src="/static/chat.jpg"></img>
      ...
      <div class="formcontainer">
      <div class="container">
        <label for="ufname"><strong>Thanks for using our chatbot</strong></label></br></br>
"""
...
def endchat():
    ...
    [Creator Details]<br>
    <label for="ufname"><strong>Gayathri Punukollu, punukogi@mail.uc.edu</strong></label></br></br>
    """
